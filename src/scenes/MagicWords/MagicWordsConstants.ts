import { MagicWordsData } from "./MagicWordsLogic";

export const BASE_PADDING     = 16;
export const BASE_AVATAR_SIZE = 64;
export const BASE_EMOJI_SIZE  = 20;
export const BASE_LINE_HEIGHT = 24;
export const BASE_FONT_SIZE   = 18;
export const BUBBLE_RADIUS    = 12;
export const BUBBLE_COLORS    = { left: 0x1a2a4a, right: 0x2a1a4a };
export const ACCENT_COLORS    = { left: 0x4466ff, right: 0xaa44ff };

export const API_URL = 'https://private-624120-softgamesassignment.apiary-mock.com/v2/magicwords';
export const FALLBACK_DATA: MagicWordsData = {
    dialogue: [
